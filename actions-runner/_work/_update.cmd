...
setlocal
set runnerpid=109988
set runnerprocessname=Runner.Listener.exe
set rootfolder=D:\GitHub\URMS\actions-runner
set existrunnerversion=2.310.2
set downloadrunnerversion=2.333.1
set logfile=D:\GitHub\URMS\actions-runner\_diag\SelfUpdate-20260412-141343.log
...
if %restartinteractiverunner% equ 1 (
  ...
  endlocal
  start "Actions Runner" cmd.exe /k "D:\GitHub\URMS\actions-runner\run.cmd"
) else (
  endlocal
)
