...
| B-012 | Resource リレーション実装 | Developer | done | S14 · API + migration · 2026-07-06 |
| B-013 | Phase 4 品質・運用（S11〜S13） | Developer | done | tag `v0.3.0` · 2026-07-05 |
...
| B-024 | WCAG 改善（暫定 Web 5173） | Developer | **cancelled** | 5173 削除 · 2026-07-08 |
